    ...
    <div className={className}>
      ...
      {showHint ? (
        <p className="text-[11px] adm-faint mt-1.5">
          {accept === "image"
            ? profile === "hero"
              ? "До 30 МБ. Главный баннер: до 3840px, WebP качество 88."
              : `До 30 МБ за файл. JPG, PNG, WebP, GIF, SVG, AVIF — растр режется до 1280px и сохраняется как WebP (качество 75).${multiple ? " Несколько файлов: Ctrl/⌘ + выбор или Shift + диапазон." : ""}`
