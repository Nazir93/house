  ...
  power: [
    {
      ...
      tier2: [
        { id: "pw-1", label: "Штробление и закладные" },
        { id: "pw-2", label: "Монтаж кабельных трасс" },
        { id: "pw-3", label: "Сборка щитового оборудования" },
        { id: "pw-4", label: "Освещение и розеточные группы" },
      ],
    },
  ],
