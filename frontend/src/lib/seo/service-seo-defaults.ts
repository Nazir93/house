...
const SERVICE_SEO_BY_SLUG = {
  proektirovanie: {
    /** ТЗ SEO §10 */
    title: `Проектирование частных домов в СПб и Ленинградской области | ${S}`,
    description:
      "Индивидуальное проектирование частных домов в Санкт-Петербурге и Ленинградской области. Архитектурные и конструктивные решения, посадка дома на участок и подготовка проекта к строительству.",
    keywords: [
      `проектирование частных домов ${C}`,
    ...
    h1: "Проектирование частных домов",
    landingTheses: [
      "Закрывает спрос на проектирование частных домов в СПб и ЛО.",
      "Подчёркивает архитектуру, конструктив и посадку на участок.",
      "Без чужих доменов и чужих брендов в meta/H1.",
    ],
  },
  fundament: {
