...
export const AUTHOR_PROJECTS_CATALOG_SEO: AuthorProjectsCatalogSeo = {
  ...
  intro:
    "Каталог проектов частных домов с планировками, площадями и расчетом стоимости строительства. Проекты можно адаптировать под участок, материал стен и пожелания заказчика.",
  keywords: [
