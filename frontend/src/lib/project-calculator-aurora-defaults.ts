      ...
      items: [
        {
          id: "blind",
          name: "Отмостка",
          description: "Ширина 0,8 м по условному периметру дома.",
          price: 0,
        ...
        },
        {
          id: "drain",
          name: "Дренаж",
          description: "По условному периметру дома.",
          price: 0,
        ...
        },
        {
          id: "soffit",
          name: "Софиты",
          description: "Длина карнизов через коэффициент софитов.",
          price: 0,
        ...
        },
        {
          id: "gutter",
          name: "Водосточка",
          description: "Через коэффициент водостока по категории дома.",
          price: 0,
        ...
        },
        {
          ...
          description: "По площади кровли (building_area × коэффициент кровли).",
          price: 0,
        ...
        },
        {
          ...
          description: "По площади кровли; для мансарды — тёплый контур.",
          price: 0,
        ...
        },
        {
          ...
          description: "Доступна для мансардных и двухэтажных домов (категории d, e, f).",
          price: 0,
        ...
        },
        {
          ...
          description: "Для мансардных и двухэтажных домов (категории d, e, f).",
          price: 0,
