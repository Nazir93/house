...
export const FALLBACK_HOUSE_PROJECTS: HouseProjectItem[] = [
  {
    ...
    order: 1,
    media: [
      { id: "aurora-render-1", type: "RENDER", url: "/images/projects/house-placeholder-1.jpg", alt: "Проект Аврора", order: 0 },
      { id: "aurora-plan-1", type: "PLAN", url: "/images/projects/plan-placeholder-1.jpg", alt: "Планировка Аврора", label: "1 этаж", floor: 1, order: 0 },
    ],
  ...
  },
  {
    ...
    order: 2,
    media: [
      { id: "duet-render-1", type: "RENDER", url: "/images/projects/house-placeholder-2.jpg", alt: "Проект Дуэт", order: 0 },
      { id: "duet-plan-1", type: "PLAN", url: "/images/projects/plan-placeholder-2.jpg", alt: "План 1 этажа Дуэт", label: "1 этаж", floor: 1, order: 0 },
      { id: "duet-plan-2", type: "PLAN", url: "/images/projects/plan-placeholder-3.jpg", alt: "План 2 этажа Дуэт", label: "2 этаж", floor: 2, order: 1 },
    ],
    completion: defaultCompletion,
    constructionSchedule: defaultSchedule,
    anchors: defaultAnchors,
  },
  {
    ...
    order: 3,
    media: [
      { id: "line-render-1", type: "RENDER", url: "/images/projects/house-placeholder-3.jpg", alt: "Проект Линия", order: 0 },
    ],
    completion: defaultCompletion,
    constructionSchedule: defaultSchedule,
