...
const nextConfig = {
  ...
  images: {
    ...
    /**
     * Только WebP: AVIF на VPS при первом `/_next/image` очень тяжёлый (CPU),
     * из‑за этого галереи «тормозят» при холодном кэше. WebP достаточно лёгкий и быстрый.
     */
    formats: ["image/webp"],
    /**
     ...
     */
    qualities: [60, 70, 72, 75, 78, 80, 82, 85, 90, 96],
    /** Без 2.5K/4K — меньше вариантов /_next/image и быстрее первый LCP на мобиле. */
